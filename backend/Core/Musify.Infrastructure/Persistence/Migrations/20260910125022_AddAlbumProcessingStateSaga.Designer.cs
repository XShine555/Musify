...
namespace Musify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910125022_AddAlbumProcessingStateSaga")]
    partial class AddAlbumProcessingStateSaga
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Musify.Domain.Entities.ExternalAlbum", b =>
                {
                    b.HasBaseType("Musify.Domain.Entities.Album");
            ...
            modelBuilder.Entity("Musify.Domain.Entities.UserAlbum", b =>
                {
                    b.HasBaseType("Musify.Domain.Entities.Album");
            ...
            modelBuilder.Entity("Musify.Domain.Entities.ExternalAlbum", b =>
                {
                    b.HasOne("Musify.Domain.Entities.Album", null)
                        .WithOne()
                        .HasForeignKey("Musify.Domain.Entities.ExternalAlbum", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Musify.Domain.Entities.UserAlbum", b =>
                {
                    b.HasOne("Musify.Domain.Entities.Album", null)
                        .WithOne()
                        .HasForeignKey("Musify.Domain.Entities.UserAlbum", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
